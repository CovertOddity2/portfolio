                        ...
                        <div class="row">
                            <div class="4u">
                                ...
                                <section class="box">
                                    ...
                                    <p></p>
                                    <a href="${cvURL}" class="button alt" target="_blank">Download curriculum vitae PDF</a>
                                </section>
                            </div>
                                ...
                                <article class="box is-post">
                                    ...
                                    <section>
                                        ...
                                        <ul style="list-style: none;">
                                            ...
                                            <li>
                                                Approximately 174cm tall.
                                            </li>
                                            <li>
                                                Working with computers since approximately 1 year old.
                                            </li>
                                            <li>
                                                Loves exploring new cultures.
                                            </li>
                                            <li>
                                    ...
                                    <!-- <section>
                                        <header>
                                            <h3>Longform biography in 3rd person</h3>
                                        </header>
                                        <p>
                                            This longform biography will be filled in later,<br />
                                            <br />
                                            It might also possibly be a little vain to write this at my age...
                                        </p>
                                    </section> -->
                                </article>
                            </div>
